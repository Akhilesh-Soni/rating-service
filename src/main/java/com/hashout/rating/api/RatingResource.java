...
public class RatingResource {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RatingResource.class.getCanonicalName());
    private final RatingRequestHandler ratingRequestHandler;


    public RatingResource(final RatingRequestHandler ratingRequestHandler) {
